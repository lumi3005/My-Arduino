...
void idle() // this is the delay between the steps -> walking speed
 {
  delay(90);  // if set to a bigger number (more delay between the steps -> slower walking) you will see the walking pattern more clearly
 }
////////////////////////////////////// 
...
void forward()
{
  ...
  knee31.write(150);  // lower the diagonal opposite leg a bit to keep the balance
  knee11.write(140);
  idle();
  hip1.write(60);
  hip4.write(90);
  ...
  knee11.write(150);  // lower the diagonal opposite leg a bit to keep the balance
  knee31.write(140); 
  idle();
  hip3.write(120);
  hip1.write(120);
  ...
  knee41.write(40);  // lower the diagonal opposite leg a bit to keep the balance
  knee21.write(50);
  idle();
  hip2.write(110);
  hip3.write(60);
  ...
  knee21.write(40);  // lower the diagonal opposite leg a bit to keep the balance 
  knee41.write(50); 
  idle();
  hip4.write(30);
  hip2.write(50);
