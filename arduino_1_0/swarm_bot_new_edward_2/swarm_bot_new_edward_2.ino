...
#define IRR_B 8  //CON P2-6  PD6  Back touch sensor
...
void setup() {
  ...
  pinMode(IRR_F, INPUT);     // Front Center IR LED input Attiny pin
  pinMode(IRR_L, INPUT);     // Front Left   IR LED input Attiny pin
  pinMode(IRR_R, INPUT);     // Front Right  IR LED input Attiny pin
  pinMode(IRR_B, INPUT);     // Back  Back IR LED input Attiny pin
  ...
  /* Testing the motor and LED functions */
    delay(1000);
    turnLeft(255);
    delay(350);
    turnRight(255);
