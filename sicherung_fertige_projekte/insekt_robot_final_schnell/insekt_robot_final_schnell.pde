...
// Modified by Lutz Michaelis, April 2011 (add sound function, adjust the servo variables), http://www.roboter-selbstgebaut.com
#include <Servo.h>
Servo frontServo;
Servo rearServo;
...
int walkSpeed = 300; // How long to wait between steps in milliseconds
int centerTurnPos = 81;
int frontTurnRightUp = 63;
int frontTurnLeftUp = 127;
int backTurnRightForward = 66;
int backTurnLeftForward = 126;
