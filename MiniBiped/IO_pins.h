...
// ===== SERVO PINS =====
#define Panpin          13  // digital pin 13 - Pan servo
#define Lhippin         12  // digital pin  5 - Left  hip   servo
#define Rhippin         11  // digital pin  6 - Right hip   servo
#define Lkneepin        10  // digital pin  7 - Left  knee  servo
#define Rkneepin         9  // digital pin  8 - Right knee  servo
...
#define SharpEyepin       5  // analog pin 5
